	...
	if(!empty($name) && !empty($emailid) && !empty($phone))
	{
		...
		if($_POST['g-recaptcha-response'] && !empty($_POST['g-recaptcha-response']))
		{
			...
			if(!empty($responseData) && $responseData->success)
			{
                    ...
                    <tr bgcolor="#EEEEEE">
                    <td ><span style="color:#000000; font-size:14px; font-family:Arial; font-weight:bold;">Welcome Sanali website Marketing Associate Details</span></td>
                    </tr>
                    <tr>
                      <td class="style1">Details are below: </td>
                    </tr>
                    <tr>
                    ...
                    try {
                        ...
                        $mail->Subject = 'Sanali website Marketing Associate Details';
                        $mail->Body    = $message;
