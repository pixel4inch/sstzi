	...
	if(!empty($name) && !empty($emailid) && !empty($phone))
	{
		...
		if($_POST['g-recaptcha-response'] && !empty($_POST['g-recaptcha-response']))
		{
			...
			if(!empty($responseData) && $responseData->success)
			{
				...
				$cvsData = $name . "," . $emailid . "," . $phone ."," . $company ."," . $message. ",". $cdate .", \r\n";

				$file_path = __DIR__ . "/contact_page_lead.csv";
				...
				if($fp)
				{
                    ...
                    <tr bgcolor="#EEEEEE">
                    <td ><span style="color:#000000; font-size:14px; font-family:Arial; font-weight:bold;">Welcome Sanali website contact enquiry</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td width="124"  class="style1"><strong> Message :</strong></td>
                      <td width="456" class="style1">'.$message.'</td>
                    </tr>
                    ...
                    try {
                        ...
                        $mail->Subject = 'Sanali website contact enquiry';
                        $mail->Body    = $message;
